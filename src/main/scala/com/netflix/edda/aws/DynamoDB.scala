...
object DynamoDB {
  ...
  def init(tableName: String, readCap: Long, writeCap: Long)(
  ...
  def get(tableName: String, name: String, value: String)(
    implicit client: AmazonDynamoDBClient,
    req: RequestId
  ...
  def put(tableName: String, attributes: Map[String, Any], expected: Map[String, Any] = Map())(
    implicit client: AmazonDynamoDBClient,
    req: RequestId
  ) = {
    import collection.JavaConverters._
