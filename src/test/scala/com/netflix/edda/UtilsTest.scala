...
class UtilsTest extends FunSuite {
  ...
  "list" : [
    ...
    test("diffRecords") {
        val r1 = Record("id", 1).copy(stime=new DateTime(0))
        val r2 = Record("id", 2).copy(stime=new DateTime(1))
...
"""
        ...
        val r3 = Record("id", List("this", "is", "a", "test")).copy(stime=new DateTime(0))
        val r4 = Record("id", List("this", "is", "a", "great", "test")).copy(stime=new DateTime(1))
        val r5 = Record("id", List("this", "is", "an", "even", "better", "test")).copy(stime=new DateTime(2))
